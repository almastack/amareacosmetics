...
import { Building2, Leaf, MapPin, Mail, FileText, Users, Briefcase, GraduationCap, Scale } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mb-16">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-light mb-4 text-neutral-800">Informazioni Societarie</h2>
                <div className="bg-neutral-50 p-6 rounded-lg space-y-3 text-neutral-700 font-sans">
                  <p><strong>Data di costituzione:</strong> 06 ottobre 2025</p>
                  <p><strong>Luogo:</strong> Civitanova Marche (MC)</p>
                  <p><strong>Notaio:</strong> Dott. Piergiorgio Moscetta - Via Montenero, 9 - 62012 Civitanova Marche</p>
                  <p><strong>Sede principale:</strong> Contrada Brecce Bianche snc, 60131 Ancona (AN) - DiSVA</p>
                  <p><strong>Settore:</strong> Lifescience</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-light mb-4 text-neutral-800">Oggetto Sociale</h2>
                <div className="text-neutral-700 font-sans leading-relaxed">
                  <p>
                    AMAREA Cosmetics si occupa della <strong>ricerca, sviluppo e produzione di cosmetici naturali 
                    ed ecosostenibili</strong>, realizzati a partire da materie prime di origine vegetale e da 
                    sottoprodotti dell'industria agroalimentare attraverso processi di <strong>upcycling</strong>.
                  </p>
                  <p className="mt-4">
                    Le attività di ricerca e sviluppo vengono svolte in collaborazione con l'<strong>Università 
                    Politecnica delle Marche</strong>, dove avvengono la selezione dei principi attivi, la 
                    validazione scientifica degli ingredienti e la messa a punto delle formulazioni.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-light mb-4 text-neutral-800">Attività di Ricerca e Sviluppo</h2>
                <div className="text-neutral-700 font-sans leading-relaxed space-y-4">
                  <p>
                    L'attività innovativa è focalizzata sullo <strong>sviluppo di formulazioni cosmetiche basate 
                    su ingredienti di origine vegetale</strong>, con particolare attenzione al riutilizzo dei 
                    bioresidui dell'industria agroalimentare marchigiana, dai quali vengono estratti principi 
                    attivi ad alto valore biologico per l'arricchimento delle formulazioni.
                  </p>
                  <p>
                    Le attività di ricerca comprendono la <strong>caratterizzazione chimico-fisica e biologica 
                    degli estratti</strong> e la <strong>valutazione dell'efficacia in vitro dei prototipi</strong>.
                  </p>
                  <div className="bg-neutral-50 p-6 rounded-lg border-l-4 border-primary mt-4">
                    <h3 className="font-semibold mb-3 text-neutral-800">Spese di Ricerca e Sviluppo</h3>
                    <p>
                      Le spese di ricerca e sviluppo riguardano consulenze scientifiche, materiali di laboratorio, 
                      test di efficacia e sicurezza, studi analitici e attività di progettazione e sviluppo di 
          ...
          <div className="mb-16">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-light text-neutral-800">Il Nostro Team</h2>
              </div>
              <p className="text-neutral-600 font-sans">
                Un gruppo di professionisti altamente qualificati con competenze complementari
              </p>
            </div>

            <div className="space-y-8">
              {teamMembers.map((member, index) => (
                <div key={index} className="bg-neutral-50 p-6 rounded-lg hover:shadow-md transition">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <a href={`mailto:${member.email}`} className="text-sm text-neutral-600 hover:text-primary transition mb-3 inline-block">
                        {member.email}
                      </a>
            ...
            <div className="mt-8 bg-neutral-50 p-6 rounded-lg border-l-4 border-primary">
              ...
              <p className="text-sm text-neutral-600 font-sans mt-2">
                Il legale rappresentante della società dichiara, ai sensi degli articoli 46, 47 e 76 del D.P.R. 445/2000, 
                la veridicità dell'elenco soci iscritto al Registro delle Imprese e la sua trasparenza rispetto a fiduciarie o holding.
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-light mb-4 text-neutral-800">Partnership e Collaborazioni</h2>
                <div className="bg-neutral-50 from-primary/10 to-primary/5 p-8 rounded-lg">
                  <div className="flex items-center gap-4 mb-4">
                    <div>
                      <h3 className="text-xl font-medium text-neutral-800">Università Politecnica delle Marche</h3>
                      <p className="text-sm text-neutral-600">Partner strategico per ricerca e sviluppo</p>
                    </div>
                  </div>
                  <p className="text-neutral-700 font-sans leading-relaxed">
                    AMAREA Cosmetics intrattiene <strong>relazioni professionali e di collaborazione</strong> con 
                    l'Università Politecnica delle Marche, dove vengono svolte le principali attività di ricerca e 
                    sviluppo dei prodotti. Questa partnership garantisce solide basi scientifiche e validazione 
                    accademica delle formulazioni sviluppate.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16">
            <div className="bg-neutral-50 p-6 rounded-lg">
              <p className="text-neutral-700 font-sans">
                <strong>Società partecipate:</strong> Nessuna società partecipata
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-neutral-50 p-8 rounded-lg">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-light text-neutral-800">Sede Principale</h3>
                </div>
                <p className="text-neutral-700 font-sans leading-relaxed">
                  Contrada Brecce Bianche, snc<br />
                  60131 Ancona (AN)<br />
